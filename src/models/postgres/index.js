...
StudyGoal.init({
  ...
  examType:       { type: DataTypes.ENUM('WAEC','JAMB','NECO','IELTS','GCSE','MIXED'), allowNull: false },
...
Assignment.init({
  ...
  examType:    { type: DataTypes.ENUM('WAEC','JAMB','NECO','IELTS','GCSE','MIXED'), defaultValue: 'MIXED' },
...
module.exports = { StudyGoal, Assignment, AssignmentSubmission, School, Class, Question };